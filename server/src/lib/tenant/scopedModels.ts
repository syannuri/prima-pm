// The 45 tenant-scoped Prisma models (see docs/MULTITENANCY-POOLED-PLAN.md). Every one carries a
...
export const SCOPED_MODELS: ReadonlySet<string> = new Set([
  ...
  'ApprovalWorkflow', 'ApprovalRequest', 'ApprovalDelegation', 'AiActionProposal', 'AiActionOutcome',
  ...
  'RequirementTaskLink', 'ProjectCommentary', 'AiBriefing', 'AiMemory', 'AiFeedback',
]);
