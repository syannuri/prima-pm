...
import { projectValueRouter as customFieldValueRoutes } from '../customField/customField.routes.js';
import crossDepRoutes from '../schedule/crossDep.routes.js';
...
router.use('/:projectId/custom-fields', customFieldValueRoutes);
router.use('/:projectId/cross-deps', crossDepRoutes);
