    ...
    <div ref={rootRef} className={className}>
      <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl ring-1 ring-slate-200">
        ...
        <div className="relative aspect-[16/10] bg-white">
          {SCENES.map(({ Comp }, n) => (
            <div key={n} aria-hidden={n !== i} className={`absolute inset-0 transition-opacity duration-700 ${n === i ? 'opacity-100 pmx-scene-in pmx-play' : 'pointer-events-none opacity-0'}`}>
