...
const ACCENTS: Accent[] = [
  ...
  { solid: 'bg-slate-700',   spine: 'border-l-slate-700',   tint: 'bg-slate-100 dark:bg-transparent',  text: 'text-slate-700 dark:text-slate-300',    ring: 'ring-slate-300 dark:ring-slate-700' },
