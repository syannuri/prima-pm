          ...
          <table className="w-full border-separate border-spacing-0 text-sm">
            <thead>
              ...
              <tr className="text-center text-xs font-bold uppercase tracking-wide text-slate-800 dark:text-slate-100 [&>th]:sticky [&>th]:top-0 [&>th]:z-20 [&>th]:bg-slate-200 [&>th]:dark:bg-slate-800 [&>th]:py-2 [&>th]:px-2 [&>th]:border-slate-300 [&>th]:border-r [&>th]:border-r-slate-300/80 dark:[&>th]:border-r-slate-700 [&>th:last-child]:border-r-0">
                ...
                {show('pct') && <th rowSpan={showDates ? 2 : 1} style={colStyle('pct')} onContextMenu={(e) => openColMenu('pct', '% complete', e)} className="relative cursor-context-menu border-b border-slate-200 text-center align-bottom dark:border-slate-800" title="% complete — right-click to hide"><span className="inline-flex flex-col items-center leading-tight"><span className="text-[9px] font-semibold uppercase tracking-wide text-slate-400 dark:text-slate-500">Progress</span><span>%</span></span><ColGrip col="pct" /></th>}
